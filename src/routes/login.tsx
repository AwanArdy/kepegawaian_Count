          ...
          <div className="mt-10 pt-8 border-t border-border">
            <div className="p-4 rounded-xl bg-muted/50 border border-border">
              <div className="flex gap-3">
                ...
                <div>
                  <div className="text-sm font-semibold mb-1">Akun Demo (Coba Sekarang)</div>
                  <div className="text-xs text-muted-foreground space-y-1">
                    <p>
                      Username:{" "}
                      <code className="bg-background px-1 rounded text-primary">admin</code> atau{" "}
                      <code className="bg-background px-1 rounded text-primary">pegawai</code>
                    </p>
                    <p>
                      Password:{" "}
                      <code className="bg-background px-1 rounded text-primary">password</code> (min
                      6 char)
                    </p>
                  </div>
                </div>
