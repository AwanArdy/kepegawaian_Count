  ...
  return (
    <AppShell title={isPegawai ? "Jadwal KGB Saya" : "Monitoring Kenaikan Gaji Berkala"}>
      <div className="space-y-5">
            ...
            <div className="divide-y divide-border">
              {list.length > 0 ? (
                ...
                <div className="p-10 text-center text-muted-foreground">
                  <Wallet className="size-12 mx-auto opacity-20 mb-3" />
        ...
        {isPegawai && (
          <div className="p-4 rounded-xl bg-success/5 border border-success/10 text-sm text-muted-foreground flex gap-3">
